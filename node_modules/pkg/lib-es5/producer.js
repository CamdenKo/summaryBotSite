  ...
  return new _promise2.default(function (resolve, reject) {
    ...
    (0, _multistream2.default)(function (cb) {
      if (count === 0) {
        ...
        if (recentStripe) {
          var _recentStripe = recentStripe,
              snap = _recentStripe.snap,
              store = _recentStripe.store;
        ...
        if (stripes.length) {
          var stripe = stripes.shift();
          recentStripe = stripe;

          if (stripe.buffer) {
            if (stripe.store === _common.STORE_BLOB) {
              var _snap = (0, _common.snapshotify)(stripe.snap, slash);
              return (0, _fabricator.fabricate)(bakes, target.fabricator, _snap, stripe.buffer, function (error, buffer) {
