  ...
  (0, _createClass3.default)(Walker, [{
    ...
    value: function stepDetect(record, derivatives) {
      ...
      try {
        _detector2.default.detect(body, function (node, trying) {
          var fromDictionary = record.marker.fromDictionary;
          ...
          if (d) {
            if (d.mustExclude) return false;
            var debug = fromDictionary || d.mayExclude || trying;
          ...
          if (d) {
            ...
            var _debug = fromDictionary || trying;
    ...
    value: function () {
      var _ref5 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee5(record, derivative) {
        var catcher, stage, newPackage, newMarker, newFile1, failure, isNear, mainNotFound, short, _failure, message, name, fromDictionary, debug, level;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 29:
                ...
                fromDictionary = record.marker.fromDictionary;
                debug = fromDictionary || derivative.mayExclude || mainNotFound;
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 15:
                ...
                if (record.marker.permissive || record.marker.fromDictionary) {
    ...
    key: 'start',
    value: function () {
      var _ref11 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee11(marker, entrypoint) {
        var tasks, i;
